...
\begin{itemize}
    ...
    \item \textbf{Métrica 1.5 - Fração de Métodos de Passo com Implementação:} razão entre o número de métodos de passo implementados e o total de métodos de passo gerados, calculada por história de usuário. Formalmente:
    \item \textbf{Métrica 1.6 - Fração de Métodos de Passo sem Implementação:} razão entre o número de métodos de passo sem implementação e o total de métodos de passo gerados, também por história de usuário. Formalmente:
    \item \textbf{Métrica 1.7 - Fração de Métodos POM com Implementação:} razão entre o número de métodos POM implementados e o total de métodos POM gerados, por história de usuário. Formalmente:
    \item \textbf{Métrica 1.8 - Fração de Métodos POM sem Implementação:} razão entre o número de métodos POM sem implementação e o total de métodos POM gerados, por história de usuário. Formalmente:
...
\subsection{Módulo 2: Geração do Código de Teste}
...
\begin{itemize}
    ...
    \item exemplos de cenários Dado/Quando/Então;

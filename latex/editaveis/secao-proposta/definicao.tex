...
As fontes primárias de dados do estudo são duas. A primeira corresponde ao conjunto de issues registradas no ZenHub, vinculado ao repositório do projeto, que contêm as Histórias de Usuário (HUs), seus respectivos Critérios de Aceitação (CAs), etiquetas de classificação e, em alguns casos, comentários complementares inseridos pela equipe ao longo do desenvolvimento.

A segunda fonte de dados corresponde ao repositório digital do projeto, do qual serão extraídas informações contextuais complementares, especialmente elementos de interface presentes no código-fonte e outros artefatos técnicos necessários para interpretar as histórias de usuário e seus critérios de aceitação.

Não haverá coleta direta com usuários, desenvolvedores ou outros stakeholders, pois o fenômeno investigado já ocorreu e não pode ser reconstituído em seu contexto original. Dessa forma, toda a análise se apoia em evidências históricas registradas no projeto, em conformidade com a natureza retrospectiva do estudo.

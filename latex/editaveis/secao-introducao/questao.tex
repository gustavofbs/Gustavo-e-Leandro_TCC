...
\begin{table}[h]
    ...
    \begin{tabular}{|p{5cm}|p{9cm}|}
        ...
        \hline
        \textbf{Com respeito ao} & utilização de especificações de Desenvolvimento Orientado ao Comportamento (BDD) em conjunto com técnicas de Inteligência Artificial para identificação de elementos da interface gráfica e geração de testes automatizados. \\
        \hline

...
\begin{table}[h]
    ...
    \begin{tabular}{|p{5cm}|p{9cm}|}
        ...
        \hline
        \textbf{Analisar} & a característica de qualidade de produto de software referente à Manutenibilidade, em particular a subcaracterística de Testabilidade, considerada sob a perspectiva de qualidade interna. \\ 
        \hline
        ...
        \hline
        \textbf{No contexto do} & projetos de software que adotam BDD ou integração de IA para análise de interfaces gráficas, com código aberto em plataformas colaborativas como GitHub\\
        \hline
    \end{tabular} \\[0.5em]

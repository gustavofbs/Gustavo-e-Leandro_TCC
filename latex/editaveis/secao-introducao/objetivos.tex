...
O principal objetivo desta monografia é identificar como a escrita de especificações de Desenvolvimento Orientado ao Comportamento (BDD) influenciam a capacidade de modelos baseados em Inteligência Artificial de identificar, de forma autônoma, elementos de interface gráfica necessários para gerar testes de sistema automatizados. Para alcançar esse propósito, foram definidos os seguintes objetivos específicos:

\begin{itemize} 
    \item Fundamentar os conceitos relacionados a Engenharia de Software Experimental, modelos de qualidade de software, princípios da Metodologia Ágil, BDD e Processamento de Linguagem Natural (NLP), destacando fatores que influenciam na interpretação por parte de sistemas de IA; 

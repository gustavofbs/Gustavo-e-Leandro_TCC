...
Segundo a ISO/IEC/IEEE 29119-1 e a ISO/IEC/IEEE 12207,
a Verificação e a Validação (V\&V) consistem em processos distintos,
porém complementares, que integram as práticas de garantia da qualidade
em Engenharia de Software, utilizando o teste como uma de suas principais
atividades de apoio \cite{iso29119_1_2022,iso12207_2017}.

A verificação consiste em avaliar se cada artefato produzido ao longo do ciclo de vida do sistema está correto, completo e consistente com os requisitos estabelecidos. O IEEE 1012 organiza a verificação como um conjunto de atividades sistemáticas que ocorrem em todos os processos técnicos, incluindo análise de requisitos, definição de arquitetura, projeto e integração, com o objetivo de produzir evidências objetivas de que o produto em construção atende às especificações impostas. O padrão descreve tarefas como análise de requisitos, avaliação de arquitetura, rastreabilidade e revisões críticas como parte essencial do processo de verificação, assegurando que cada elemento do sistema esteja sendo construído corretamente segundo critérios mensuráveis e revisões formais \cite{IEEE1012-2016}.

A validação complementa a verificação ao buscar determinar se o sistema resultante atende às necessidades e expectativas dos usuários e demais partes interessadas. Enquanto a verificação concentra-se na conformidade com especificações, a validação volta-se à adequação do sistema ao seu propósito no contexto real de uso. De acordo com o IEEE 1012, as atividades de validação acompanham diversos processos do ciclo de vida, envolvendo testes de qualificação, testes de aceitação e análise dos resultados de operação, com o objetivo de confirmar que o sistema é adequado ao propósito a que se destina. A validação depende de evidências obtidas por meio de testes integrados e avaliações em contexto real, garantindo que o produto final não apenas esteja correto do ponto de vista técnico, mas também seja apropriado ao ambiente operacional pretendido \cite{IEEE1012-2016}.

Dessa forma, os testes de software constituem um dos principais mecanismos para produzir evidências objetivas que sustentam as atividades de verificação e validação. Sua eficácia depende não apenas da correta definição dos casos de teste, mas também da capacidade de executá-los de forma consistente e sustentável ao longo da evolução do sistema.

\section{Testes de Software}

Segundo a ISO/IEC/IEEE 29119-1, o teste de software é definido como um conjunto
de atividades realizadas com o objetivo de facilitar a descoberta e a avaliação
das propriedades de itens de teste, contribuindo para a identificação de defeitos
e para a avaliação do comportamento do software \cite{iso29119_1_2022}.

Os principais objetivos do teste incluem a detecção de defeitos, a coleta de
informações relevantes sobre o item de teste e o fornecimento de confiança para
apoiar a tomada de decisões ao longo do ciclo de vida do software.

Além da detecção de defeitos, o teste de software desempenha papel fundamental
no apoio à tomada de decisões relacionadas à aceitação e à liberação do produto,
fornecendo informações que subsidiam atividades de gestão e garantia da qualidade
\cite{jalote2005}.

Um item de teste corresponde a qualquer produto de trabalho passível de avaliação,
incluindo componentes de software, sistemas completos, documentos de requisitos,
especificações de projeto ou outros artefatos produzidos ao longo do
desenvolvimento \cite{iso29119_1_2022}.

Devido à complexidade inerente aos sistemas de software, a execução de testes
exaustivos é impraticável na maioria dos casos, caracterizando o teste como um
processo de amostragem no qual se busca selecionar casos de teste com maior
probabilidade de revelar defeitos \cite{iso29119_1_2022}.

Nesse contexto, a série de normas ISO/IEC/IEEE 29119 recomenda a adoção de testes
baseados em risco como estratégia para a seleção e priorização de testes,
direcionando o esforço para as funcionalidades e cenários com maior impacto
potencial em caso de falha \cite{iso29119_1_2022,iso29119_2_2021}.

As técnicas de design de teste consistem em procedimentos sistemáticos utilizados
para criar modelos de teste, identificar itens de cobertura e derivar casos de
teste a partir desses modelos \cite{iso29119_4_2021}.

De acordo com a ISO/IEC/IEEE 29119-4, essas técnicas podem ser classificadas em
técnicas baseadas em especificação, técnicas baseadas em estrutura e técnicas
baseadas em experiência \cite{iso29119_4_2021}.

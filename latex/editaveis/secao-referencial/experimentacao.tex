...
\textcolor{blue}{Eric Evans}\todo[color=yellow]{Citar referência.}
...
A ISO/IEC 25010 é a evolução da ISO 9126\textcolor{blue}{software}\todo[color=yellow]{Novamente, o problema do registro bibtex} \cite{ISO25010}.
\todo[inline, color=pink]{Escrever uma frase antes dessas duas destacando as principais alterações propostas pela ISO 25010}
 No visão da Qualide em Uso, a qualidade é avaliada conforme a interação do usuário com o sistema, contemplando cinco características principais: efetividade, eficiência, satisfação, ausência de riscos e cobertura de contexto. Já a Qualidade de Produto foca nas visões da qualidade internas e externas do sistema e contempla oito características: adequação funcional, eficiência de desempenho, compatibilidade, usabilidade, confiabilidade, segurança, manutenibilidade e  \textcolor{blue}{portabilidade}\todo[color=yellow]{Novamente, o problema do registro bibtex} \cite{ISO25010}.
...
A norma não apresenta metodologias como o Behavior-Driven Development (BDD) nem critérios para avaliar de forma objetiva a clareza e o propósito de cenários comportamentais. Também não oferece diretrizes para estruturar requisitos textuais que facilitem a interpretação automática por modelos de linguagem (LLMs). 

\todo[inline, color=pink]{Mudei o parágrafo anterior de lugar. De aqualquer forma precisa ser reescrito. A ISO não vai apresentar isso mesmo. Contextualizar o BDD segundo a sua respectiva característica e sub. Manter coerência com a definição do GQM}

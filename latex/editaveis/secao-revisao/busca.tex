...
\begin{table}[ht]
    ...
    \begin{tabular}{|p{.5cm}|p{6cm}|p{4cm}|p{4cm}|}
        ...
        1 & \textit{A Behavior-driven Development and Reinforcement Learning approach for videogame automated testing} & — & — \\ \hline
        2 & \textit{AI Driven Tools in Modern Software Quality Assurance: An Assessment of Benefits, Challenges and Future Directions} & — & — \\ \hline
        3 & \textit{AI-Generated Test Scripts for Web E2E Testing with ChatGPT and Copilot: A Preliminary Study} & — & — \\ \hline
        4 & \textit{Acceptance Test Generation with Large Language Models: An Industrial Case Study} & — & — \\ \hline
        5 & \textit{Agentic AI for Behavior-Driven Development Testing Using Large Language Models} & — & — \\ \hline
        6 & \textit{Agile testing using user language automation with artificial intelligence in Enjisset} & — & — \\ \hline
        7 & \textit{An Autonomous RL Agent Methodology for Dynamic Web UI Testing in a BDD Framework} & — & — \\ \hline
        8 & \textit{Assessing the Quality of Behavior-Driven Development Scenarios Using BERT} & — & — \\ \hline
        9 & \textit{Automatic Generation of Acceptance Test Cases from Use Case Specifications: An NLP-Based Approach} & — & — \\ \hline
        10 & \textit{Comprehensive Evaluation and Insights Into the Use of Large Language Models in the Automation of Behavior-Driven Development Acceptance Test Formulation} & — & — \\ \hline
        11 & \textit{Cypress Copilot: Development of an AI Assistant for Boosting Productivity and Transforming Web Application Testing} & — & — \\ \hline
...
\begin{table}[ht]
    ...
    \begin{tabular}{|p{.5cm}|p{6cm}|p{4cm}|p{4cm}|}
        ...
        12 & \textit{Empowering Agile-Based Generative Software Development through Human-AI Teamwork} & — & — \\ \hline
        13 & \textit{Exploring LLMs Impact on Student-Created User Stories and Acceptance Testing in Software Development} & — & — \\ \hline
        14 & \textit{Exploring Large Language Models for Requirements on String Values} & — & — \\ \hline
        15 & \textit{Generating Multiple Conceptual Models from Behavior-Driven Development Scenarios} & — & — \\ \hline
        16 & \textit{Object Oriented BDD and Executable Human-Language Module Specification} & — & — \\ \hline
        17 & \textit{Prompting Creative Requirements via Traceable and Adversarial Examples in Deep Learning} & — & — \\ \hline
        18 & \textit{RiverGame-a game testing tool using artificial intelligence} & — & — \\ \hline
        19 & \textit{Test Case Prioritization Based on Neural Network Classification with Artifacts Traceability} & — & — \\ \hline
        20 & \textit{The Impact of Generative AI on Test \& Evaluation: Challenges and Opportunities} & — & — \\ \hline
        21 & \textit{Towards Code Generation from BDD Test Case Specifications: A Vision} & — & — \\ \hline
        22 & \textit{Visual Test Framework: Enhancing Software Test Automation with Visual Artificial Intelligence and Behavioral Driven Development} & — & — \\ \hline
    \end{tabular}

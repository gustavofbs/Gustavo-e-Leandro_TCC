...
\todo[inline, color=pink]{Escrever uma frase ou parágrafo, se for o caso, esplicando que as questões da tabela 3 são secundárias em relação a principal e que são específicas deste estudo.}

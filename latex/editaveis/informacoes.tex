...
% Dados do trabalho
\titulo{Escrita e Estruturação de Especificações BDD para Automação de Testes de Sistema Baseada em Inteligência Artificial: Um estudo sobre a identificação autônoma de elementos de interface gráfica por sistemas baseados em IA}
\data{2025}
